...
# def run_interpolated_climb_phase(params, wind_speed_scenario, crosswind_speed_scenario, initial_weight, initial_time, initial_horizontal_distance, initial_roc, final_roc, total_climb_time):
#     """
#     Runs a climb phase with interpolated ROC from initial_roc to final_roc over total_climb_time.
#     """
...
#     return results, weight, time, horizontal_distance, total_power, cumulative_fuel_consumed, total_carbon_emissions, total_co_emissions, total_nox_emissions, total_so2_emissions
...
def run_interpolated_climb_phase(params, wind_speed_scenario, crosswind_speed_scenario, initial_weight, initial_time, initial_horizontal_distance, initial_roc, final_roc, total_climb_time, previous_engine_power=None, cumulative_fuel_consumed=0, total_carbon_emissions=0, total_co_emissions=0, total_nox_emissions=0, total_so2_emissions=0, initial_cumulative_battery_energy_consumed=0):
    """
    Runs a climb phase with interpolated ROC from initial_roc to final_roc over total_climb_time.
    """
    def roc_scenario(time, initial_roc, final_roc, total_climb_time):
    ...
    while altitude < target_altitude or airspeed < final_airspeed:
        ...
        power_drag = drag * true_airspeed
        power_climb = weight * roc
        total_power = (power_drag + power_climb) / propeller_efficiency
    ...
    # , , , , , , , , , , , final_altitude, required_batteries
