...
def run_all_phases(engine_turn_on_params, taxi_params, takeoff_params, take_off_C_params, phase1_params, phase2_params, phase3_params, cruise_params, descent_params, approach_and_landing_params, taxi_params2, num_engines=2):
    ...
    combined_results = pd.concat([turn_on_results, results_taxi, results_takeoff, results_take_off_C, results_phase1, results_phase2, results_phase3, results_cruise, results_descent, results_approach_and_landing, results_taxi2], ignore_index=True)
